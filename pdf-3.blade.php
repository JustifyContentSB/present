...
<style>
	...
	*::after {-webkit-box-sizing:inherit;box-sizing:inherit}
	...
	@font-face {
	  font-family: 'Stem';
	  src: url("/pdf/fonts/stem/Stem-Light.eot?#iefix") format("embedded-opentype"), url("/pdf/fonts/stem/Stem-Light.woff2") format("woff2"), url("/pdf/fonts/stem/Stem-Light.woff") format("woff"), url("/pdf/fonts/stem/Stem-Light.ttf") format("truetype"), url("/pdf/fonts/stem/Stem-Light.svg") format("svg");
	  font-weight: 300;
	  font-style: normal;
	  font-display: swap;
	}
	...
	@font-face {
	  font-family: 'Stem';
	  src: url("/pdf/fonts/stem/Stem-SemiLight.eot?#iefix") format("embedded-opentype"), url("/pdf/fonts/stem/Stem-SemiLight.woff2") format("woff2"), url("/pdf/fonts/stem/Stem-SemiLight.woff") format("woff"), url("/pdf/fonts/stem/Stem-SemiLight.ttf") format("truetype"), url("/pdf/fonts/stem/Stem-SemiLight.svg") format("svg");
	  font-weight: 350;
	  font-style: normal;
	  font-display: swap;
	}
	...
	@font-face {
	  font-family: 'Stem';
	  src: url("/pdf/fonts/stem/Stem-Regular.eot?#iefix") format("embedded-opentype"), url("/pdf/fonts/stem/Stem-Regular.woff2") format("woff2"), url("/pdf/fonts/stem/Stem-Regular.woff") format("woff"), url("/pdf/fonts/stem/Stem-Regular.ttf") format("truetype"), url("/pdf/fonts/stem/Stem-Regular.svg") format("svg");
	  font-weight: 400;
	  font-style: normal;
	  font-display: swap;
	}
	...
	@font-face {
	  font-family: 'Stem';
	  src: url("/pdf/fonts/stem/Stem-Medium.eot?#iefix") format("embedded-opentype"), url("/pdf/fonts/stem/Stem-Medium.woff2") format("woff2"), url("/pdf/fonts/stem/Stem-Medium.woff") format("woff"), url("/pdf/fonts/stem/Stem-Medium.ttf") format("truetype"), url("/pdf/fonts/stem/Stem-Medium.svg") format("svg");
	  font-weight: 500;
	  font-style: normal;
	  font-display: swap;
	}
	...
	@font-face {
	  font-family: 'Stem';
	  src: url("/pdf/fonts/stem/Stem-Bold.eot?#iefix") format("embedded-opentype"), url("/pdf/fonts/stem/Stem-Bold.woff2") format("woff2"), url("/pdf/fonts/stem/Stem-Bold.woff") format("woff"), url("/pdf/fonts/stem/Stem-Bold.ttf") format("truetype"), url("/pdf/fonts/stem/Stem-Bold.svg") format("svg");
	  font-weight: 700;
	  font-style: normal;
	  font-display: swap;
	}
			...
			<tr>
				<td>
					<table class="header" cellpadding="0" cellspacing="0" align="center" style="padding:95px 0 60px; padding-left: 100px; width: 100%;">
						<tbody>
							<tr><td class="header__title" style="color:rgba(0, 0, 0, 0.9); font-size:56px; font-weight:bold; line-height:56px">Knightsbridge Private Park</td></tr>
