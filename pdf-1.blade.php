...
<body style='font-family:"Stem", sans-serif; letter-spacing:0.1rem; margin:0'>
	...
	<table class="cover" cellpadding="0" cellspacing="0" style="background:url(/pdf/images/01.jpg); background-repeat:no-repeat; background-size:cover; background-position:center; min-height:2718px; min-width:1900px; padding-left:245px; padding-right:245px; width:100%" width="100%">
		<tbody>
			<tr>
				<td valign="top">
