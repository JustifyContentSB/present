...
<head>
	...
	<link rel="stylesheet" href="css/obj4/style.min.css">
			...
			<tr>
				<td>
					...
					<table class="about" cellpadding="0" cellspacing="0" width="1900" align="left">
						<tbody>
							<tr>
								<td class="about__qr" valign="top"><img src="/pdf/images/qr.svg" alt="qr" width="193" height="193"></td>
							...
							<tr>
								<td class="info__td" align="left">
									<table class="info__left" cellpadding="0" cellspacing="0" align="left" width="650">
										<tbody>
											<tr><td class="info__left-title">Класс</td><td>Клубный дом</td></tr>
											<tr><td class="info__left-title">Готовность</td><td>Сдача в 2020</td></tr>
											<tr><td class="info__left-title">Инфраструктура</td><td>Бассейн, парковая зона</td></tr>
										</tbody>
									</table>
								</td>
							</tr>
					...
					<table class="text text--barkli">
						<tbody>
							<tr>
								<td>Пентхаус на последнем этаже известного дома купца Филатова — элитный жилой дом, известный москвичам как «Дом с рюмкой», находится в начале улицы Остоженка.
								В квартире высокие потолки — 3,4 метра, удобная планировка: светлая гостиная с тремя окнами и видом на Кремль.</td>
							</tr>
						</tbody>
					</table>	
